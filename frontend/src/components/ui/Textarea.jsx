...
export default function Textarea({
  ...
  return (
    <div className="w-full">
      {label && (
        <label htmlFor={textareaId} className="mb-2 block text-sm font-semibold text-[rgb(var(--bubo-color-text))]">
          {label}
